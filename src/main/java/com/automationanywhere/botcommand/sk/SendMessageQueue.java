...
@BotCommand
@CommandPkg(label = "Send Message Queue", name = "SendMessageQueue", description = "Sends a message to queue", 
icon = "pkg.svg", group_label="Queue" , node_label = "Send Message Queue {{sessionName}}|", comment = true , text_color = "#dc7ca3" , background_color =  "#dc7ca3" ) 
public class SendMessageQueue {
    ...
    public void action(@Idx(index = "1", type = TEXT) @Pkg(label = "Session Name",  default_value_type = STRING, default_value = "Default") @NotEmpty String sessionName,
    	...
    	connection.sendMessageQueue(queue, message,properties);
